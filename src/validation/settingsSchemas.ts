...
export const preferencesUpdateSchema = z.object({
  ...
  default_reminder: z.enum(['1 day before', '3 days before', '1 week before', 'custom', 'none']).optional(),
  default_custom_reminder_value: z.number().int().positive().optional().nullable(),
  default_custom_reminder_unit: z.enum(['minutes', 'hours', 'days', 'weeks']).optional().nullable(),
  default_custom_reminder_minutes: z.number().int().min(10).max(43200).optional().nullable(),
