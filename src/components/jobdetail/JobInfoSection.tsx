  ...
  return (
    <article className="card stack gap-10">
      ...
      <div className="job-info-groups">
        <section className="job-info-group">
          <p className="job-info-group-title">Order</p>
          <div className="stack gap-8">
            <InfoRow icon={<Layers2 size={14} />} label="Mode" value={details.orderMode} />
            ...
            <InfoRow icon={<Users size={14} />} label="Scope" value={job.jobType} />
            <div className="row-between">
              <p className="text-sm text-muted row gap-4">
                <Ruler size={14} />
                Measurement
        ...
        <section className="job-info-group">
          <p className="job-info-group-title">Material</p>
          <div className="stack gap-8">
            ...
            <InfoRow icon={<ShieldCheck size={14} />} label="Quality" value={details.materialQuality} />
            <InfoRow icon={<Truck size={14} />} label="Source" value={details.materialSource} />
          </div>
        </section>
      </div>
    </article>
